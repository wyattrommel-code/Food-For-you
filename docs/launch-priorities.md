# Launch direction — September 14, 2026

Mealsolved's main purpose is helping people decide what to eat. Affordable meals are a useful side effect of eating at home, not the launch product's central promise. Dedicated budget optimization or a paid budgeting feature is deferred until there is a larger team and more evidence.

Current order agreed with Wyatt:

1. Release the completed discovery, treats/drinks and calendar-planner changes to Google Play's existing internal testing track.
2. Grow the shared catalog from 293 to at least 500 recipes while Wyatt recruits 18 more testers. Follow the established recipe format, approachable meals and matching photos, with no new subscriptions. Check for duplicate dishes and validate recipe quality before importing.
