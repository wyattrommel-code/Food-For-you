...
const defaults={disliked_ingredients:[],disliked_cuisines:[],liked_ingredients:[],liked_cuisines:[],diet_style:'any',preferred_meal_styles:[],max_cook_time_mins:null,prefer_easy:false,household_size:1,onboarding_completed_at:now};
